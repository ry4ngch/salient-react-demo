    ...
    return (
        <React.Fragment>
            <div className="content">
                <h2>Welcome</h2>
                <p>This demo site was created to showcase the features of <code>Salient</code> Library capabilities integrated with react-router-dom</p>
            </div>
            ...
            <p className="content">You can navigate and view the individual components by going to <em style={{textTransform: 'uppercase', fontWeight: 'bold'}}>Features</em> Link in the navbar or by clicking one of the link below </p>

    ...
    return (
        <>
            ...
            <Card>
                ...
                <CardContent>
                    <h4>The Salient library was developed with a core goal: to simplify the development process by eliminating the need to manually define custom states for controlling UI animations, styles, and effects. By leveraging Salient, developers can focus on building robust applications without worrying about intricate UI configurations.</h4>
                    <br/>
                    ...
                    <hr/>
                    <br/>
                    <p>You can navigate and view the individual components by going to <em style={{textTransform: 'uppercase'}}>Features</em> Link in the navbar or by clicking one of the link below </p>
                </CardContent>
                <List>
                    {featuresLinks.map((page, index) => (

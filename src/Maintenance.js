...
const Maintenance = () => {
    return (
        <article className='maintenancePage'>
            ...
            <h2 className="maintenanceNote">Temporary Downtime for Scheduled Maintenance</h2>
            <p className="maintenanceMsg">Sorry for the inconvenience. We&rsquo;re performing some maintenance at the moment.</p>
        </article>
    )
} 
